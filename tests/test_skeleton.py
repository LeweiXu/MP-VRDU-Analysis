...
MODULES = [
    ...
    "reporting.build",
    "reporting.tables",
    "reporting.tables.T1_headline",
    "reporting.tables.T6_retrieval",
    "reporting.tables._markdown",
    "gates",
    "gates.core",
    "gates.viewer",
    "experiments.G1_sufficiency",
    "experiments.G2_family",
    "experiments.G3_dataset",
    "experiments.G5_retrieval",
    "experiments.G6_classifier",
    "cli",
    "scripts.run_probe",
    "cli.generate",
    "cli.judge",
